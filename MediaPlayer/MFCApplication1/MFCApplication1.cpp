...
BEGIN_MESSAGE_MAP(CMediaPlayer, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMediaPlayer-Erstellung
...
// Das einzige CMediaPlayer-Objekt

CMediaPlayer theApp;


// CMediaPlayer-Initialisierung

BOOL CMediaPlayer::InitInstance()
{
